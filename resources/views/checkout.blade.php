...
<body>
    <div class="container">
        <div class="header">
            <h1>💳 Checkout</h1>
            <a href="{{ route('cart') }}" class="back-btn">← Back to Cart</a>
        </div>
                ...
                <div class="checkout-form">
                    ...
                    <div class="form-section">
                        ...
                        <div class="payment-methods">
                            <label class="payment-method {{ old('payment_method') == 'Card' ? 'selected' : '' }}">
                                <input type="radio" name="payment_method" value="card" {{ old('payment_method') == 'card' ? 'checked' : 'checked' }}>
                                💳 Card
                            </label>
                           
                            <label class="payment-method {{ old('payment_method') == 'Bkash' ? 'selected' : '' }}">
                                <input type="radio" name="payment_method" value="Bkash" {{ old('payment_method') == 'Bkash' ? 'checked' : '' }}>
                                📧 Bkash
                            </label>
                           
                            <label class="payment-method {{ old('payment_method') == 'bank_transfer' ? 'selected' : '' }}">
                    ...
                    <div class="summary-totals">
                        ...
                        @if($cart->discount_amount > 0)
                            ...
                            <div class="total-row">
                                ...
                                <span>${{ number_format($cart->subtotal_after_discount, 2) }}</span>
                            </div>
                        @endif
                        <div class="total-row">
                            <span>Shipping</span>
                        ...
                        <div class="total-row">
                            <span>Tax (8%)</span>
                            <span>${{ number_format(($cart->discount_amount > 0 ? $cart->subtotal_after_discount : $cart->total_amount) * 0.08, 2) }}</span>
                        </div>
                       
                        <div class="grand-total">
                            <span>Total</span>
                            <span>${{ number_format($cart->discount_amount > 0 ? $cart->final_total : $cart->total_amount * 1.08, 2) }}</span>
                        </div>
                    </div>
