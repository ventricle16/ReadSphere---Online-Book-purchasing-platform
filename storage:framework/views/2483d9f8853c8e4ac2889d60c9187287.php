...
<div class="fullscreen-background"
     style="background-image: url('<?php echo e(asset('images/bookstore-bg.jpg')); ?>');
...
unset($__errorArgs, $__bag); ?>
            ...
            <p class="text-center mt-3 mb-0">
                ...
                <a href="<?php echo e(route('login')); ?>" class="text-decoration-none fw-semibold text-primary">Login here</a>
            </p>
        </div>
    </div>
</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\readsphere\resources\views/auth/register.blade.php ENDPATH**/ ?>